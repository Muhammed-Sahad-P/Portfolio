if (
  ((function (t, e) {
        ...
        if (s[a]) {
          if (e && (i = n ? s[a] : s[a].data)) {
            ft.isArray(e)
              ...
              : e in i
              ? (e = [e])
              : ((e = ft.camelCase(e)), (e = e in i ? [e] : e.split(" "))),
              (o = e.length);
            for (; o--; ) delete i[e[o]];
    ...
    function S(t, e) {
      ...
      if (1 === e.nodeType) {
        if (
          ((n = e.nodeName.toLowerCase()), !ut.noCloneEvent && e[ft.expando])
        ) {
          o = ft._data(e);
    ...
    function A(t, e, n, i) {
      ...
      var o,
        ...
        p = e[0],
        g = ft.isFunction(p);
      if (g || (d > 1 && "string" == typeof p && !ut.checkClone && ee.test(p)))
      ...
      if (
        ...
        for (s = (a = ft.map(h(c, "script"), C)).length; d > u; u++)
          (r = c),
            u !== f &&
              ((r = ft.clone(r, !0, !0)), s && ft.merge(a, h(r, "script"))),
            n.call(t[u], r, u);
        if (s)
          for (
    ...
    function N(t, e, n) {
      for (var i, o = e ? ft.filter(e, t) : t, r = 0; null != (i = o[r]); r++)
        n || 1 !== i.nodeType || ft.cleanData(h(i)),
          i.parentNode &&
            (n && ft.contains(i.ownerDocument, i) && g(h(i, "script")),
    ...
    function I(t) {
      ...
      return (
        n ||
          (("none" !== (n = O(t, e)) && n) ||
            ((re = (
              re || ft("<iframe frameborder='0' width='0' height='0'/>")
      ...
      for (var n, i, o, r = [], s = 0, a = t.length; a > s; s++)
        (i = t[s]).style &&
          ...
          e
            ...
            : ((o = jt(i)),
              ((n && "none" !== n) || !o) &&
                ft._data(i, "olddisplay", o ? n : ft.css(i, "display"))));
      for (s = 0; a > s; s++)
        (i = t[s]).style &&
    ...
    function P(t, e, n, i, o) {
      for (
        ...
        "margin" === n && (s += ft.css(t, n + Pt[r], !0, o)),
          i
            ? ("content" === n && (s -= ft.css(t, "padding" + Pt[r], !0, o)),
              "margin" !== n &&
                (s -= ft.css(t, "border" + Pt[r] + "Width", !0, o)))
    ...
    function j(t, e, n) {
      ...
      if (0 >= o || null == o) {
        if (
          ((0 > (o = fe(t, e, r)) || null == o) && (o = t.style[e]), le.test(o))
        )
          return o;
                ...
                (t = s[i]),
                  ...
                  s !== n &&
                    (c && n && (ft.isPlainObject(n) || (e = ft.isArray(n)))
                      ? (e
                          ? ((e = !1), (r = t && ft.isArray(t) ? t : []))
                          : (r = t && ft.isPlainObject(t) ? t : {}),
                        (s[i] = ft.extend(c, r, n)))
                      : void 0 !== n && (s[i] = n));
          return s;
        }),
    ...
    var vt = (function (t) {
      function e(t, e, n, i) {
        ...
        if (
          !i &&
          ((e ? e.ownerDocument || e : M) !== I && O(e), (e = e || I), L)
        ) {
          if (11 !== g && (d = gt.exec(t)))
            if ((o = d[1])) {
              if (9 === g) {
        ...
        var o = n.length > 0,
          ...
          s = function (i, s, a, l, c) {
            ...
            if (((p += g), o && g !== p)) {
              ...
              if (i) {
                if (p > 0) for (; g--; ) m[g] || v[g] || (v[g] = X.call(l));
                v = h(v);
              }
              G.apply(l, v),
      ...
      (b = e.support = {}),
          ...
          function (t) {
            ...
            return i !== I && 9 === i.nodeType && i.documentElement
              ? ((I = i),
                ...
                (b.getElementsByClassName = ht.test(I.getElementsByClassName)),
                ...
                (w.find.CLASS =
                  b.getElementsByClassName &&
                  function (t, e) {
                    return void 0 !== e.getElementsByClassName && L
                  ...
                  ? function (t, e) {
                      ...
                      return (
                        ...
                        (!b.sortDetached && e.compareDocumentPosition(t) === n)
                          ? t === I || (t.ownerDocument === M && j(M, t))
                            ? -1
                            : e === I || (e.ownerDocument === M && j(M, e))
                            ? 1
                            : A
                            ? Z(A, t) - Z(A, e)
                            : 0
        ...
        (e.attr = function (t, e) {
          ...
          var n = w.attrHandle[e.toLowerCase()],
            i =
              n && Q.call(w.attrHandle, e.toLowerCase()) ? n(t, e, !L) : void 0;
          return void 0 !== i
            ? i
            : b.attributes || !L
            ? t.getAttribute(e)
          ...
          if ("string" != typeof t)
            return this.pushStack(
              ft(t).filter(function () {
                for (e = 0; o > e; e++) if (ft.contains(i[e], this)) return !0;
              })
            );
    ...
    ft.fn.extend({
      has: function (t) {
        ...
        return this.filter(function () {
          for (e = 0; i > e; e++) if (ft.contains(this, n[e])) return !0;
        });
      },
      closest: function (t, e) {
        for (
          var n,
            ...
            r = [],
            s =
              wt.test(t) || "string" != typeof t ? ft(t, e || this.context) : 0;
          o > i;
          i++
        )
        ...
        when: function (t) {
          var e,
            ...
            c = function (t, n, i) {
              return function (o) {
                (n[t] = this),
                  (i[t] = arguments.length > 1 ? it.call(arguments) : o),
          ...
          (!0 === t ? --ft.readyWait : ft.isReady) ||
            ...
            (!0 !== t && --ft.readyWait > 0) ||
              ...
              ft.fn.triggerHandler &&
                (ft(nt).triggerHandler("ready"), ft(nt).off("ready"))));
        },
      }),
            ...
            if (
              ...
              for (n = s.length; n--; )
                s[n] &&
                  ...
                  ((i = ft.camelCase(i.slice(5))), l(r, i, o[i]));
    ...
    !(function () {
      ...
      for (e in { submit: !0, change: !0, focusin: !0 })
        (n = "on" + e),
          (ut[e] = n in t) ||
            (i.setAttribute(n, "t"), (ut[e] = !1 === i.attributes[n].expando));
      i = null;
    })();
    ...
    (ft.event = {
          ...
          for (c = (e = (e || "").match(At) || [""]).length; c--; )
            if (
              ...
              l &&
                ...
                delete u[p]);
            } else for (p in u) ft.event.remove(t, p + e[c], n, i, !0);
      ...
      trigger: function (e, n, i, o) {
        ...
        if (
          ...
          if (!o && !c.noBubble && !ft.isWindow(i)) {
            for (
              l = c.delegateType || p, Kt.test(l + p) || (a = a.parentNode);
              a;
              a = a.parentNode
            )
              f.push(a), (u = a);
      ...
      fix: function (t) {
        ...
        for (
          s ||
            (this.fixHooks[o] = s =
              Xt.test(o) ? this.mouseHooks : Vt.test(o) ? this.keyHooks : {}),
          ...
          setup: function () {
            return Qt.test(this.nodeName)
              ? (("checkbox" !== this.type && "radio" !== this.type) ||
                ...
                !1)
              : void ft.event.add(this, "beforeactivate._change", function (t) {
                  var e = t.target;
                  Qt.test(e.nodeName) &&
                    !ft._data(e, "change") &&
    ...
    ft.extend({
      ...
      clone: function (t, e, n) {
        ...
        if (
          (ut.html5Clone || ft.isXMLDoc(t) || !Zt.test("<" + t.nodeName + ">")
            ? (r = t.cloneNode(!0))
        ...
        return (
          (i = h(r, "script")).length > 0 && g(i, !l && h(t, "script")),
          (i = a = o = null),
          r
        );
      },
      cleanData: function (t, e) {
        for (
          ...
          if ((e || It(n)) && ((o = n[a]), (r = o && l[o]))) {
            if (r.events)
              for (i in r.events)
                u[i] ? ft.event.remove(n, i) : ft.removeEvent(n, i, r.handle);
            l[o] &&
              (delete l[o],
          ...
          return Ht(
            ...
            function (t) {
              var e = this[0] || {},
                ...
                i = this.length;
              if (void 0 === t)
                return 1 === e.nodeType ? e.innerHTML.replace(Yt, "") : void 0;
              if (
                "string" == typeof t &&
                !te.test(t) &&
                ...
                try {
                  for (; i > n; n++)
                    1 === (e = this[n] || {}).nodeType &&
                      (ft.cleanData(h(e, !1)), (e.innerHTML = t));
                  e = 0;
                } catch (t) {}
              }
        ...
        replaceWith: function () {
          ...
          return A(
            ...
            function (e) {
              ...
              ft.inArray(this, t) < 0 &&
                (ft.cleanData(h(this)), n && n.replaceChild(e, this));
            },
            t
          );
        },
    ...
    t.getComputedStyle
      ...
      : ue.currentStyle &&
        ...
        (fe = function (t, e, n) {
          ...
          return (
            (n = n || de(t)),
            null == (s = n ? n[e] : void 0) && a && a[e] && (s = a[e]),
            le.test(s) &&
              !pe.test(e) &&
              ((i = a.left),
              (o = t.runtimeStyle),
    ...
    ft.extend({
      ...
      ft.each(["height", "width"], function (t, e) {
        ft.cssHooks[e] = {
          get: function (t, n, i) {
            return n
              ? me.test(ft.css(t, "display")) && 0 === t.offsetWidth
                ? ce(t, ye, function () {
                    return j(t, e, i);
                  })
                : j(t, e, i)
            ...
            return _(
              ...
              i
                ? P(
                    ...
                    i,
                    ut.boxSizing &&
                      "border-box" === ft.css(t, "boxSizing", !1, o),
                    o
                  )
                : 0
            );
          ...
          set: function (t, e) {
            ...
            (n.zoom = 1),
              ((e >= 1 || "" === e) &&
                ...
                (n.filter = he.test(r) ? r.replace(he, o) : r + " " + o);
          },
        }),
      (ft.cssHooks.marginRight = $(ut.reliableMarginRight, function (t, e) {
        return e
          ? ce(t, { display: "inline-block" }, fe, [t, "marginRight"])
          : void 0;
      })),
      ...
      prefilters: [
        function (t, e, n) {
            ...
            1 === t.nodeType &&
              ...
              "inline" ===
                ("none" === (c = ft.css(t, "display"))
                  ...
                  : c) &&
                "none" === ft.css(t, "float") &&
                (ut.inlineBlockNeedsLayout && "inline" !== I(t.nodeName)
                  ? (f.zoom = 1)
          ...
          if (ft.isEmptyObject(d))
            "inline" === ("none" === c ? I(t.nodeName) : c) && (f.display = c);
          else {
            h
        ...
        stop: function (t, e, n) {
          ...
          return (
            ...
            this.each(function () {
              ...
              else for (o in s) s[o] && s[o].stop && ke.test(o) && i(s[o]);
              for (o = r.length; o--; )
                r[o].elem !== this ||
                  (null != t && r[o].queue !== t) ||
    ...
    ft.fn.extend({
      val: function (t) {
        ...
        return arguments.length
          ...
          : o
          ? (e =
              ft.valHooks[o.type] || ft.valHooks[o.nodeName.toLowerCase()]) &&
            "get" in e &&
      ...
      ft.extend({
        valHooks: {
          ...
          select: {
            ...
            set: function (t, e) {
              for (
                var n, i, o = t.options, r = ft.makeArray(e), s = o.length;
                s--;
          ...
          if (3 !== r && 8 !== r && 2 !== r)
            return void 0 === t.getAttribute
              ...
              : ((1 === r && ft.isXMLDoc(t)) ||
                  ((e = e.toLowerCase()),
                  (o =
                    ft.attrHooks[e] || (ft.expr.match.bool.test(e) ? Oe : Ne))),
                void 0 !== n
                  ? null === n
        ...
        propHooks: {
          tabIndex: {
            get: function (t) {
              ...
              return e
                ? parseInt(e, 10)
                : _e.test(t.nodeName) || (Pe.test(t.nodeName) && t.href)
                ? 0
                : -1;
            },
          },
      ...
      toggleClass: function (t, e) {
        ...
        return "boolean" == typeof e && "string" === n
          ...
          : this.each(function () {
              var e, i, o, r;
              if ("string" === n)
                for (i = 0, o = ft(this), r = t.match(At) || []; (e = r[i++]); )
                  o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
              else
                (void 0 !== t && "boolean" !== n) ||
                  ((e = B(this)) && ft._data(this, "__className__", e),
                  ft.attr(
                    this,
                    "class",
    ...
    (ft.parseJSON = function (e) {
      ...
      (ft.parseXML = function (e) {
        ...
        try {
          t.DOMParser
            ? ((i = new t.DOMParser()), (n = i.parseFromString(e, "text/xml")))
    ...
    ft.extend({
      ...
      ajax: function (e, n) {
            ...
            r
              ? (f.ifModified &&
                  ((x = T.getResponseHeader("Last-Modified")) &&
                    (ft.lastModified[s] = x),
                  (x = T.getResponseHeader("etag")) && (ft.etag[s] = x)),
                204 === e || "HEAD" === f.type
                  ? (C = "nocontent")
                  : 304 === e
                  ? (C = "notmodified")
                  : ((C = b.state), (d = b.data), (y = b.error), (r = !y)))
              : ((y = C), (!e && C) || ((C = "error"), 0 > e && (e = 0))),
            (T.status = e),
            (T.statusText = (n || C) + ""),
            r ? g.resolveWith(p, [d, C, T]) : g.rejectWith(p, [T, C, y]),
            T.statusCode(v),
            (v = void 0),
            c && h.trigger(r ? "ajaxSuccess" : "ajaxError", [T, f, r ? d : y]),
            m.fireWith(p, [T, C]),
            c &&
        ...
        (c = ft.event && f.global) &&
          ...
          f.hasContent ||
            (f.data &&
              ((s = f.url += (ze.test(s) ? "&" : "?") + f.data), delete f.data),
            !1 === f.cache &&
              (f.url = qe.test(s)
                ? s.replace(qe, "$1_=" + Me++)
                : s + (ze.test(s) ? "&" : "?") + "_=" + Me++)),
          f.ifModified &&
            (ft.lastModified[s] &&
              T.setRequestHeader("If-Modified-Since", ft.lastModified[s]),
        ...
        if ((u = U(Ke, f, n, T))) {
          if (((T.readyState = 1), c && h.trigger("ajaxSend", [T, f]), 2 === w))
            return T;
          f.async &&
            f.timeout > 0 &&
    ...
    (ft.param = function (t, e) {
      ...
      if (
        (void 0 === e && (e = ft.ajaxSettings && ft.ajaxSettings.traditional),
          ...
          ? ((o = e.jsonpCallback =
            ...
            i.always(function () {
              void 0 === r ? ft(t).removeProp(o) : (t[o] = r),
                e[o] && ((e.jsonpCallback = n.jsonpCallback), ln.push(o)),
    ...
    (ft.fn.load = function (t, e, n) {
      ...
      ft.each(["top", "left"], function (t, e) {
        ft.cssHooks[e] = $(ut.pixelPosition, function (t, n) {
          return n
            ? ((n = fe(t, e)), le.test(n) ? ft(t).position()[e] + "px" : n)
            : void 0;
        });
      }),
    ...
    return (
      (ft.noConflict = function (e) {
        return (
          t.$ === ft && (t.$ = fn), e && t.jQuery === ft && (t.jQuery = dn), ft
        );
      }),
      e || (t.jQuery = t.$ = ft),
      ft
        ...
        getInline: function (n, i) {
          if (($(), n.src)) {
            ...
            if (r.length) {
              ...
              s &&
                s.tagName &&
                (N || ((A = o.hiddenClass), (N = T(A)), (A = "mfp-" + A)),
          ...
          return (
            ...
            !(!n || !n.enabled) &&
              ...
              x("UpdateStatus" + i, function (t, n) {
                n.text &&
                  (n.text = B(n.text, e.currItem.index, e.items.length));
              }),
